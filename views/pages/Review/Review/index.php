<div class="page-title-head d-flex align-items-center">
    <div class="flex-grow-1">
        <h4 class="fs-xl fw-bold m-0">Reviews</h4>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-0">
                                            <a data-sort="product" href="ecommerce-product-details.html" class="link-reset">Wireless Earbuds</a>
                                        </h5>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-0">
                                            <a data-sort="product" href="ecommerce-product-details.html" class="link-reset">Smart Watch</a>
                                        </h5>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-0">
                                            <a data-sort="product" href="ecommerce-product-details.html" class="link-reset">4K Ultra HD TV</a>
                                        </h5>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-0">
                                            <a data-sort="product" href="ecommerce-product-details.html" class="link-reset">Smartphone X</a>
                                        </h5>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        <h5 class="mb-0">
                                            <a data-sort="product" href="ecommerce-product-details.html" class="link-reset">Gaming Laptop</a>
                                        </h5>
                                    </div>
                                </div>
                            </td>
