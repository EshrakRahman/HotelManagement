<div class="page-title-head d-flex align-items-center">
    <div class="flex-grow-1">
        <h4 class="fs-xl fw-bold m-0">Product Details</h4>
    </div>
                                ...
                                <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active">
                                            <img src="<?php echo $base_url ?>/assets/images/products/7.png" alt="" class="d-block w-100">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo $base_url ?>/assets/images/products/11.png" alt="" class="d-block w-100">
                                        </div>
                                        <div class="carousel-item">
                                            <img src="<?php echo $base_url ?>/assets/images/products/12.png" alt="" class="d-block w-100">
                                        </div>
                                    </div>
                                    <div class="carousel-indicators m-0 mt-3 d-lg-flex d-none position-static h-100 rounded gap-2">
                                        <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1" class="h-auto rounded bg-light-subtle border active" style="width: auto !important;">
                                            <img src="<?php echo $base_url ?>/assets/images/products/7.png" class="d-block avatar-xl" alt="indicator-img">
                                        </button>
                                        <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="1" aria-label="Slide 2" class="h-auto rounded bg-light-subtle border" style="width: auto !important;">
                                            <img src="<?php echo $base_url ?>/assets/images/products/11.png" class="d-block avatar-xl" alt="indicator-img">
                                        </button>
                                        <button type="button" data-bs-target="#carouselExampleFade" data-bs-slide-to="2" aria-label="Slide 3" class="h-auto rounded bg-light-subtle border" style="width: auto !important;">
                                            <img src="<?php echo $base_url ?>/assets/images/products/12.png" class="d-block avatar-xl" alt="indicator-img">
                                        </button>
                                    </div>
                                </div> <!-- end carousel-->

                                <div class="text-center my-3">
                                    <a href="ecommerce-add-products.html" class="btn btn-light me-1"><i class="ti ti-pencil fs-lg me-1"></i> Edit</a>
                                    <a href="ecommerce-add-products.html" class="btn btn-danger"><i class="ti ti-circle-dashed-x fs-lg me-1"></i> Delisting</a>
                                </div>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
                    </div> <!-- end col-->
                        ...
                        <div class="p-4">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="flex-grow-1 d-inline-flex align-items-center justify-content-end fs-lg">
                                    ...
                                    <span class="ti ti-star-filled text-warning"></span>
                                    <span class="ti ti-star-filled text-warning"></span>
                                    <span class="ms-1 fs-base"><a href="ecommerce-reviews.html" class="link-reset fw-medium">(859 Reviews)</a> </span>
                                </div>
                            </div>
                            <div class="mt-3 mb-4">
                                    ...
                                    <div class="row align-items-center g-0">
                                        <div class="col-xl-7">
                                            <div class="d-flex align-items-center gap-4 p-4">
                                                <img src="<?php echo $base_url ?>/assets/images/ratings.svg" alt="Product" height="80">
                                                <div>
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="<?php echo $base_url ?>/assets/images/users/user-8.jpg" alt="avatar-8" class="img-fluid rounded-circle">
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="<?php echo $base_url ?>/assets/images/users/user-6.jpg" alt="avatar-6" class="img-fluid rounded-circle">
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="<?php echo $base_url ?>/assets/images/users/user-3.jpg" alt="avatar-3" class="img-fluid rounded-circle">
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="<?php echo $base_url ?>/assets/images/users/user-2.jpg" alt="avatar-2" class="img-fluid rounded-circle">
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex justify-content-start align-items-center gap-2">
                                                        <div class="avatar avatar-sm">
                                                            <img src="<?php echo $base_url ?>/assets/images/users/user-4.jpg" alt="avatar-4" class="img-fluid rounded-circle">
                                                        </div>
                                                        <div>
