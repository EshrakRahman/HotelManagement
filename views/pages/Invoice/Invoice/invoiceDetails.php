<div class="page-title-head d-flex align-items-center">
    <div class="flex-grow-1">
        <h4 class="fs-xl fw-bold m-0">Invoice Details</h4>
    </div>
                    ...
                    <div class="card-body px-4">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3 border-bottom pb-3">
                            <div class="auth-brand mb-0">
                                <a href="index.html" class="logo-dark">
                                    <img src="<?php echo $base_url ?>/assets/images/logo-black.png" alt="dark logo" height="24">
                                </a>
                                <a href="index.html" class="logo-light">
                                    <img src="<?php echo $base_url ?>/assets/images/logo.png" alt="logo" height="24">
                                </a>
                            </div>
                            <div class="text-end">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4 text-end">
                                <img src="<?php echo $base_url ?>/assets/images/qr.png" alt="Barcode" class="img-fluid" style="max-height: 80px;">
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <img src="<?php echo $base_url ?>/assets/images/sign.png" alt="Company Signature" height="30">
