...
<div class="row">
    <div class="col-12">
        <article class="card overflow-hidden mb-0">
            <div class="position-relative card-side-img overflow-hidden" style="min-height: 300px; background-image: url(<?php echo $base_url; ?>/assets/images/profile-bg.jpg);">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        <div class="me-3 position-relative">
                            <img src="<?php echo $base_url; ?>/assets/images/users/user-3.jpg" alt="avatar" class="rounded-circle" width="72" height="72">
                        </div>
                        <div>
                            <h5 class="mb-0 d-flex align-items-center">
                                <a href="#!" class="link-reset">Geneva Lee</a>
                                <img src="<?php echo $base_url; ?>/assets/images/flags/us.svg" alt="US" class="ms-2 rounded-circle" height="16">
                            </h5>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="avatar avatar-sm">
                                                        <img src="<?php echo $base_url; ?>/assets/images/users/user-7.jpg" alt="avatar" class="img-fluid rounded-circle">
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="avatar avatar-sm">
                                                        <img src="<?php echo $base_url; ?>/assets/images/users/user-8.jpg" alt="avatar" class="img-fluid rounded-circle">
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="avatar avatar-sm">
                                                        <img src="<?php echo $base_url; ?>/assets/images/users/user-9.jpg" alt="avatar" class="img-fluid rounded-circle">
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="avatar avatar-sm">
                                                        <img src="<?php echo $base_url; ?>/assets/images/users/user-10.jpg" alt="avatar" class="img-fluid rounded-circle">
                                                    </div>
                                                    <div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="avatar avatar-sm">
                                                        <img src="<?php echo $base_url; ?>/assets/images/users/user-2.jpg" alt="avatar" class="img-fluid rounded-circle">
                                                    </div>
                                                    <div>
                        ...
                        <div class="tab-pane show active" id="timeline">
                            ...
                            <div class="border border-light border-dashed rounded p-2 mb-3">
                                <div class="d-flex align-items-center mb-2">
                                    <img class="me-2 avatar-md rounded-circle" src="<?php echo $base_url; ?>/assets/images/users/user-3.jpg" alt="Generic placeholder image">
                                    <div class="w-100">
                                ...
                                <img src="<?php echo $base_url; ?>/assets/images/stock/small-1.jpg" alt="post-img" class="rounded me-1" height="60" />
                                <img src="<?php echo $base_url; ?>/assets/images/stock/small-2.jpg" alt="post-img" class="rounded me-1" height="60" />
                                <img src="<?php echo $base_url; ?>/assets/images/stock/small-3.jpg" alt="post-img" class="rounded" height="60" />
                            ...
                            <div class="border border-light border-dashed rounded p-2 mb-3">
                                <div class="d-flex align-items-center mb-2">
                                    <img class="me-2 avatar-sm rounded-circle" src="<?php echo $base_url; ?>/assets/images/users/user-4.jpg" alt="Generic placeholder image">
                                    <div class="w-100">
                                ...
                                <div class="bg-light-subtle m-n2 p-2 border-top border-bottom border-dashed">
                                    <div class="d-flex align-items-start">
                                        <img class="me-2 avatar-sm rounded-circle" src="<?php echo $base_url; ?>/assets/images/users/user-1.jpg" alt="Generic placeholder image">
                                        <div class="w-100">
                                            <h5 class="mt-0 mb-1">
                                            ...
                                            <div class="d-flex align-items-start mt-3">
                                                <a class="pe-2" href="#">
                                                    <img src="<?php echo $base_url; ?>/assets/images/users/user-2.jpg" class="avatar-sm rounded-circle" alt="Generic placeholder image">
                                                </a>
                                                <div class="w-100">
                                                    <h5 class="mt-0 mb-1">
                                    ...
                                    <div class="d-flex align-items-start mt-2">
                                        <a class="pe-2" href="#">
                                            <img src="<?php echo $base_url; ?>/assets/images/users/user-3.jpg" class="rounded-circle" alt="Generic placeholder image" height="31">
                                        </a>
                                        <div class="w-100">
                            ...
                            <div class="border border-light border-dashed rounded p-2 mb-3">
                                <div class="d-flex align-items-center mb-2">
                                    <img class="me-2 avatar-sm rounded-circle" src="<?php echo $base_url; ?>/assets/images/users/user-2.jpg" alt="Profile photo of Anika Roy">
                                    <div class="w-100">
