                ...
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div class="ms-auto">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="users-role-details.html"><i class="ti ti-eye me-2"></i>View</a>
                                        </li>
                        ...
                        <div class="avatar-group avatar-group-sm mb-3">
                            <div class="avatar">
                                <img src="<?php echo $base_url ?>/assets/images/users/user-7.jpg" alt="" class="rounded-circle avatar-sm">
                            </div>
                            <div class="avatar">
                                <img src="<?php echo $base_url ?>/assets/images/users/user-8.jpg" alt="" class="rounded-circle avatar-sm">
                            </div>
                            <div class="avatar">
                                <img src="<?php echo $base_url ?>/assets/images/users/user-9.jpg" alt="" class="rounded-circle avatar-sm">
                            </div>
                            <div class="avatar">
                                <img src="<?php echo $base_url ?>/assets/images/users/user-10.jpg" alt="" class="rounded-circle avatar-sm">
                            </div>
                        </div>

                        <div class="d-flex justify-content-between align-items-center">
                            <span class="text-muted fs-xs"><i class="ti ti-clock me-1"></i>Updated 1 hour ago</span>
                            <a href="users-role-details.html" class="btn btn-sm btn-outline-primary rounded-pill">Details</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <div class="avatar-group avatar-group-sm mb-3">
                            <div class="avatar"><img src="<?php echo $base_url ?>/assets/images/users/user-2.jpg" class="rounded-circle avatar-sm" alt=""></div>
                            <div class="avatar"><img src="<?php echo $base_url ?>/assets/images/users/user-5.jpg" class="rounded-circle avatar-sm" alt=""></div>
                            <div class="avatar"><img src="<?php echo $base_url ?>/assets/images/users/user-6.jpg" class="rounded-circle avatar-sm" alt=""></div>
                            <div class="avatar"><img src="<?php echo $base_url ?>/assets/images/users/user-1.jpg" class="rounded-circle avatar-sm" alt=""></div>
                            <div class="avatar"><img src="<?php echo $base_url ?>/assets/images/users/user-8.jpg" class="rounded-circle avatar-sm" alt=""></div>
                        </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <div class="avatar-group avatar-group-sm mb-3">
                            <div class="avatar"><img src="<?php echo $base_url ?>/assets/images/users/user-3.jpg" class="rounded-circle avatar-sm" alt=""></div>
                            <div class="avatar"><img src="<?php echo $base_url ?>/assets/images/users/user-4.jpg" class="rounded-circle avatar-sm" alt=""></div>
                            <div class="avatar"><img src="<?php echo $base_url ?>/assets/images/users/user-9.jpg" class="rounded-circle avatar-sm" alt=""></div>
                            <div class="avatar"><img src="<?php echo $base_url ?>/assets/images/users/user-10.jpg" class="rounded-circle avatar-sm" alt=""></div>
                ...
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        <div class="avatar-group avatar-group-sm mb-3">
                            <div class="avatar"><img src="<?php echo $base_url ?>/assets/images/users/user-1.jpg" class="rounded-circle avatar-sm" alt=""></div>
                            <div class="avatar"><img src="<?php echo $base_url ?>/assets/images/users/user-5.jpg" class="rounded-circle avatar-sm" alt=""></div>
                            <div class="avatar"><img src="<?php echo $base_url ?>/assets/images/users/user-7.jpg" class="rounded-circle avatar-sm" alt=""></div>
                        </div>
                        ...
                        <table class="table table-custom table-centered table-select table-hover w-100 mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm"><img src="<?php echo $base_url ?>/assets/images/users/user-5.jpg" class="img-fluid rounded-circle" alt=""></div>
                                            <div>
                                                <h5 class="fs-base mb-0"><a data-sort="user" href="users-profile.html" class="link-reset">Nathan
                                                        Young</a></h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm"><img src="<?php echo $base_url ?>/assets/images/users/user-3.jpg" class="img-fluid rounded-circle" alt=""></div>
                                            <div>
                                                <h5 class="fs-base mb-0"><a data-sort="user" href="users-profile.html" class="link-reset">Leah
                                                        Kim</a></h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm"><img src="<?php echo $base_url ?>/assets/images/users/user-1.jpg" class="img-fluid rounded-circle" alt=""></div>
                                            <div>
                                                <h5 class="fs-base mb-0"><a data-sort="user" href="users-profile.html" class="link-reset">Sophie
                                                        Lee</a></h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm"><img src="<?php echo $base_url ?>/assets/images/users/user-2.jpg" class="img-fluid rounded-circle" alt=""></div>
                                            <div>
                                                <h5 class="fs-base mb-0"><a data-sort="user" href="users-profile.html" class="link-reset">David
                                                        Tran</a></h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm"><img src="<?php echo $base_url ?>/assets/images/users/user-4.jpg" class="img-fluid rounded-circle" alt=""></div>
                                            <div>
                                                <h5 class="fs-base mb-0"><a data-sort="user" href="users-profile.html" class="link-reset">Isabella
                                                        Moore</a></h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm"><img src="<?php echo $base_url ?>/assets/images/users/user-6.jpg" class="img-fluid rounded-circle" alt=""></div>
                                            <div>
                                                <h5 class="fs-base mb-0"><a data-sort="user" href="users-profile.html" class="link-reset">Daniel
                                                        Cooper</a></h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm"><img src="<?php echo $base_url ?>/assets/images/users/user-8.jpg" class="img-fluid rounded-circle" alt=""></div>
                                            <div>
                                                <h5 class="fs-base mb-0"><a data-sort="user" href="users-profile.html" class="link-reset">Ava
                                                        Thompson</a></h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm"><img src="<?php echo $base_url ?>/assets/images/users/user-9.jpg" class="img-fluid rounded-circle" alt=""></div>
                                            <div>
                                                <h5 class="fs-base mb-0"><a data-sort="user" href="users-profile.html" class="link-reset">Mason
                                                        Carter</a></h5>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="avatar avatar-sm"><img src="<?php echo $base_url ?>/assets/images/users/user-10.jpg" class="img-fluid rounded-circle" alt=""></div>
                                            <div>
                                                <h5 class="fs-base mb-0"><a data-sort="user" href="users-profile.html" class="link-reset">Chloe
                                                        Adams</a></h5>
