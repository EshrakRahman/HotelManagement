        ...
        <div class="card">
            <div class="card-body text-center">
                ...
                <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                    <a href="users-profile.html" class="link-reset">Sophia Carter</a>
    ...
    <div class="col-md-6 col-xxl-3">
        <div class="card">
            <div class="card-body text-center">
                ...
                <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                    <a href="users-profile.html" class="link-reset">Daniel Lee</a>
    ...
    <div class="col-md-6 col-xxl-3">
        <div class="card">
            <div class="card-body text-center">
                ...
                <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                    <a href="users-profile.html" class="link-reset">Maria Rodriguez</a>
    ...
    <div class="col-md-6 col-xxl-3">
        <div class="card">
            <div class="card-body text-center">
                ...
                <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                    <a href="users-profile.html" class="link-reset">Liam Zhang</a>
    ...
    <div class="col-md-6 col-xxl-3">
        <div class="card">
            <div class="card-body text-center">
                ...
                <!-- Name & Flag -->
                <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                    <a href="users-profile.html" class="link-reset">Ethan Wright</a>
    ...
    <div class="col-md-6 col-xxl-3">
        <div class="card">
            <div class="card-body text-center">
                ...
                <!-- Name & Flag -->
                <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                    <a href="users-profile.html" class="link-reset">Isabella Moretti</a>
    ...
    <div class="col-md-6 col-xxl-3">
        <div class="card">
            <div class="card-body text-center">
                ...
                <!-- Name & Flag -->
                <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                    <a href="users-profile.html" class="link-reset">Kenji Tanaka</a>
    ...
    <div class="col-md-6 col-xxl-3">
        <div class="card">
            <div class="card-body text-center">
                ...
                <!-- Name & Flag -->
                <h5 class="mb-0 mt-2 d-flex align-items-center justify-content-center">
                    <a href="users-profile.html" class="link-reset">Amira El-Sayed</a>
