            ...
            <form action="" method="post">
              <div class="mb-3">
                ...
                <div class="input-group">
                  <input type="text" name="txtUsername" class="form-control" id="userEmail" placeholder="you@example.com" required>
                </div>
              </div>
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  <input type="password" name="txtPassword" class="form-control" id="userPassword" placeholder="••••••••" required>
                </div>
              </div>
              ...
              <div class="d-grid">
                <button type="submit" name="btnSignIn" class="btn btn-primary fw-semibold py-2">Sign In</button>
              </div>
            </form>
